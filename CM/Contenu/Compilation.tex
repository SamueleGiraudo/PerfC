...
Une \alert{bibliothèque} est un {\bf regroupement de modules} offrant
des fonctionnalités allant vers un même objectif.
\bigskip
...
Ce projet utilise deux bibliothèques statiques~: \Code{libm.a} et
\Code{libMLV.a}.
\medskip
